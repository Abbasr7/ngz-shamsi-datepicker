...
import { valueFunctionProp } from '../../core/util';
import { DateHelperService, NZ_DATE_FORMATS, NzCalendarI18nInterface, NzDateDisplayFormats, NzI18nService } from '../../i18n';
...
export class DateTableComponent extends AbstractTable implements OnChanges, OnInit {
  ...
  override getClassMap(cell: DateCell): { [key: string]: boolean } {
    const date = (<CandyDate>cell.value).clone();
    return {
